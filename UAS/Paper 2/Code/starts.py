...
if __name__ == '__main__':
    ...
    print ("\n[Analysis Statistics]")
    print ("Tweets => Total:", num_tweets), (" Positive:", num_pos_emojis), (" Negative:"), num_neg_tweets
    print ("User Mentions => Total:"),num_mentions,(" Avg:"), num_mentions / float(num_tweets),(" Max:"), max_mentions
    print ("URLs => Total:"),num_urls, (" Avg:"),num_urls / float(num_tweets), (" Max:"),  max_urls
    print ("Emojis => Total:"),num_pos_emojis, (" Positive:"),num_neg_emojis, (" Negative:"),num_neg_emojis,  (" Avg:"), num_emojis / float(num_tweets), (" Max:"),  max_emojis
    print ("Words => Total"),num_words, (" Unique:"),num_unique_words, (" Avg:"), num_words / float(num_tweets), (" Max:"),max_words,(" Min:"), min_words
    print ("Bigrams => Total"),num_bigrams, (" Unique:"),num_unique_bigrams, (" Avg:"),num_bigrams / float(num_tweets)